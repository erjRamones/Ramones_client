...
const people = [
    {
        ...
        imageUrl:
            'https://assetsio.gnwcdn.com/Genshin-Impact-Arlecchino-materials%2C-kit%2C-and-Constellations-cover.jpg?width=1200&height=630&fit=crop&enable=upscale&auto=webp',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
    ...
    
    {
        ...
        imageUrl:
            'https://i.pinimg.com/originals/6a/8e/ec/6a8eec0c734b7f873141b54dc48e95d4.jpg',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
